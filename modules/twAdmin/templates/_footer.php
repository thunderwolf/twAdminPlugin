...
<footer id="twadmin-footer">
	<div class="<?php echo $container_type ?>">
		<div class="row">
			<div class="span6"><?php echo __('Copyright &copy; %years_period% %site_name%. All rights reserved', array('%years_period%' => $years_period, '%site_name%' => twAdmin::getProperty('site'))); ?></div>
