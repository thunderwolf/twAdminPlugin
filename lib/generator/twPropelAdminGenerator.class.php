 ...
 */
class twPropelAdminGenerator extends sfPropelGenerator {
	...
	public function getLinkToAction($actionName, $params, $pk_link = false) {
		...
		return '[?php echo link_to(\'<i class="' . $params['icon'] . '"></i>'
				. $label . ', \'' . $this->getModuleName() . '/' . $action
				. $url_params . ', ' . $this->asPhp($params['params']) . ') ?]';
	}
}
