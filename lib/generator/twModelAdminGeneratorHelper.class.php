...
/**
 * twAdmin Model generator helper.
 *
 ...
 */
abstract class twModelAdminGeneratorHelper extends sfModelGeneratorHelper
{
    ...
    public function linkToNew($params)
    {
        ...
        return link_to(
            '<i class="' . $params['icon'] . ' icon-white"></i>' . $label,
            '@' . $this->getUrlForAction('new'),
            array(
                'title' => $title,
                'class' => 'btn btn-primary ' . $params['size']
            ));
    }
    ...
    public function linkToEdit($object, $params)
    {
        ...
        return link_to(
            '<i class="' . $params['icon'] . '"></i>' . $label,
            $this->getUrlForAction('edit'), $object,
            array('title' => $title, 'class' => 'btn ' . $params['size']));
    }
    ...
    public function linkToDelete($object, $params)
    {
        ...
        return link_to(
            ...
            array(
                'title' => $title,
                'class' => 'btn btn-danger ' . $params['size'],
                'method' => 'delete',
